...
export const mockContents: ContentDTO[] = [
  {
    id: "c1",
    title: "Introdução ao Juros Simples",
    body: "Conceitos fundamentais de juros simples e suas aplicações.",
    mediaUrl: null,
    categoryId: "1-1",
    createdBy: "user1",
...
export const mockProgress: UserContentProgressDTO[] = [
  {
    ...
    categoryId: "955a6e76-4b5a-4d1a-bd1c-b36a00e68a1e",
    categoryName: "Juros",
    completedAt: new Date().toISOString(), // example: treat as completed in mock
  },
];
...
export const mockCompleteResponse: CompleteContentResponseDTO = {
  ...
  profile: { level: 3, xpTotal: 1234 },
  achievementsUnlocked: [{ id: "ach-1", title: "First Content Completed" }],
  completedAtUtc: new Date().toISOString(),
  challengesProgress: [],
  nextRecommended: [
    { id: "next-1", title: "Juros Compostos", contentId: "c-next-1" },
  ],
};